...
// Agentic
// Agentic dedupe & merge with conflict resolution (name + image + SKU signals)
...
export default function GapAgentic() {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      ...
      <p style={{ color: '#555', marginBottom: 20 }}>Agentic dedupe & merge with conflict resolution (name + image + SKU signals)</p>
