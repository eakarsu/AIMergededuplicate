...
// Bulk
// Bulk edit workflow UI

export default function GapBulk() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-bulk', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Bulk</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Bulk edit workflow UI</p>
