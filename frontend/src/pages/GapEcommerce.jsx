...
// Ecommerce
// Ecommerce integration (Shopify, WooCommerce) webhooks

export default function GapEcommerce() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-ecommerce', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Ecommerce</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Ecommerce integration (Shopify, WooCommerce) webhooks</p>
