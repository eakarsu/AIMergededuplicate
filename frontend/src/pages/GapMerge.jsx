...
// Merge
// Merge preview / approval workflow

export default function GapMerge() {
  ...
  const runAnalysis = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-merge', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: 24, maxWidth: 960, margin: '0 auto' }}>
      <h1 style={{ fontSize: 28, marginBottom: 6 }}>Merge</h1>
      <p style={{ color: '#555', marginBottom: 20 }}>Merge preview / approval workflow</p>
